...
pub struct PreparedBlockCommand<'a> {
    ...
    // SYSCOIN: V32 binds upgrade authorization through canonical batch input; the V31-only
    // settlement transaction hash is intentionally not carried in live block commands.
