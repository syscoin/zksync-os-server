...
use zksync_os_storage_api::{
    ...
    state_override_view::{OverriddenStateView, StateOverrideError},
};
...
pub enum EthCallError {
    ...
    // SYSCOIN: Reject full `AccountOverride.state` until the flat storage
    // reader can enforce full account-storage replacement semantics.
    #[error(transparent)]
    StateOverride(#[from] StateOverrideError),
