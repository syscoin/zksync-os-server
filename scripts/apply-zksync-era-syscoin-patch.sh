...
require_marker "std::env::var(\"ZK_TOKEN_ASSET_ID\")" "zkstack_cli/crates/config/src/forge_interface/deploy_ecosystem/input.rs"
require_marker "zkTokenAssetId" "contracts/l1-contracts/deploy-scripts/DeployUtils.s.sol"
require_marker "config.zkTokenAssetId" "contracts/l1-contracts/deploy-scripts/DeployL1CoreContracts.s.sol"
