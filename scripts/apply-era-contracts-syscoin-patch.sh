...
base_patch_core_applied() {
  ...
  && grep -q "0x2a04d7134e8503a441c2e8cb92979405c80cf38349f895639821046d455e5a24" "${CONTRACTS_PATH}/l1-contracts/contracts/state-transition/verifiers/ZKsyncOSVerifierPlonk.sol" \
